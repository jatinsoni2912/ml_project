...
class ConvolutionalProcessingBlock_bn_no_out(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation):
        super(ConvolutionalProcessingBlock_bn_no_out, self).__init__()
...
class ConvolutionalDimensionalityReductionBlock_bn_no_out(nn.Module):
    def __init__(self, input_shape, num_filters, kernel_size, padding, bias, dilation, reduction_factor):
        super(ConvolutionalDimensionalityReductionBlock_bn_no_out, self).__init__()
