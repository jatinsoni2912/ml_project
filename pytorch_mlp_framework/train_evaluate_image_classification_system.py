...
elif args.block_type == 'BN_no_out':
    processing_block_type = ConvolutionalProcessingBlock_bn_no_out
    dim_reduction_block_type = ConvolutionalDimensionalityReductionBlock_bn_no_out
